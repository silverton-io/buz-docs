---
title: Send webhook data to Vitess
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Vitess.
...
## Buz makes it easy to collect webhook data and send it to Vitess using your **own infrastructure**.
