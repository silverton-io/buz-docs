---
title: Send webhook data to Elasticsearch
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Elasticsearch.
keywords: [webhook, Elasticsearch, webhook to Elasticsearch, event tracking, free, open-source, Buz]
---

# Send webhook data to Elasticsearch for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Elasticsearch using your **own infrastructure**.
