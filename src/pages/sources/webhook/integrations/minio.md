---
title: Send webhook data to Minio
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Minio.
keywords: [webhook, Minio, webhook to Minio, event tracking, free, open-source, Buz]
---

# Send webhook data to Minio for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Minio using your **own infrastructure**.
