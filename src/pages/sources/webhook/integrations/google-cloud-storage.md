---
title: Send webhook data to Google Cloud Storage
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Google Cloud Storage.
keywords: [webhook, Google Cloud Storage, webhook to Google Cloud Storage, event tracking, free, open-source, Buz]
---

# Send webhook data to Google Cloud Storage for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Google Cloud Storage using your **own infrastructure**.
