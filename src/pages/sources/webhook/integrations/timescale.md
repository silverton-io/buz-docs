---
title: Send webhook data to Timescale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Timescale.
keywords: [webhook, Timescale, webhook to Timescale, event tracking, free, open-source, Buz]
---

# Send webhook data to Timescale for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Timescale using your **own infrastructure**.
