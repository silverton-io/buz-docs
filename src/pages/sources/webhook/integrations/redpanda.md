---
title: Send webhook data to Redpanda
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Redpanda.
keywords: [webhook, Redpanda, webhook to Redpanda, event tracking, free, open-source, Buz]
---

# Send webhook data to Redpanda for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Redpanda using your **own infrastructure**.
