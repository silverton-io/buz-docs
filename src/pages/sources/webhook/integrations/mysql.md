---
title: Send webhook data to MySQL
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to MySQL.
keywords: [webhook, MySQL, webhook to MySQL, event tracking, free, open-source, Buz]
---

# Send webhook data to MySQL for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to MySQL using your **own infrastructure**.
