---
title: Send webhook data to Pubnub
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Pubnub.
keywords: [webhook, Pubnub, webhook to Pubnub, event tracking, free, open-source, Buz]
---

# Send webhook data to Pubnub for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Pubnub using your **own infrastructure**.
