---
title: Send webhook data to Materialize
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Materialize.
keywords: [webhook, Materialize, webhook to Materialize, event tracking, free, open-source, Buz]
---

# Send webhook data to Materialize for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Materialize using your **own infrastructure**.
