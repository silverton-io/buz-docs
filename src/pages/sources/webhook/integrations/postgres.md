---
title: Send webhook data to Postgres
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Postgres.
keywords: [webhook, Postgres, webhook to Postgres, event tracking, free, open-source, Buz]
---

# Send webhook data to Postgres for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Postgres using your **own infrastructure**.
