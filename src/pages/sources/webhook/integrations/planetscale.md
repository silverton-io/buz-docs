---
title: Send webhook data to Planetscale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Planetscale.
...
## Buz makes it easy to collect webhook data and send it to Planetscale using your **own infrastructure**.
