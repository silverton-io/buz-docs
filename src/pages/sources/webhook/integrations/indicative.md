---
title: Send webhook data to Indicative
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Indicative.
keywords: [webhook, Indicative, webhook to Indicative, event tracking, free, open-source, Buz]
---

# Send webhook data to Indicative for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Indicative using your **own infrastructure**.
