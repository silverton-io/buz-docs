---
title: Send webhook data to Amplitude
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to Amplitude.
keywords: [webhook, Amplitude, webhook to Amplitude, event tracking, free, open-source, Buz]
---

# Send webhook data to Amplitude for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to Amplitude using your **own infrastructure**.
