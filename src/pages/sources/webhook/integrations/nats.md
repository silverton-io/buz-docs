---
title: Send webhook data to NATS
description: Buz is a free and open-source project that makes it easy to collect, validate, and load webhook data to NATS.
keywords: [webhook, NATS, webhook to NATS, event tracking, free, open-source, Buz]
---

# Send webhook data to NATS for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect webhook data and send it to NATS using your **own infrastructure**.
