---
title: Send pixel data to Vitess
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Vitess.
keywords: [pixel, Vitess, pixel to Vitess, event tracking, free, open-source, Buz]
---

# Send pixel data to Vitess for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Vitess using your **own infrastructure**.
