---
title: Send pixel data to AWS Kinesis Firehose
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to AWS Kinesis Firehose.
keywords: [pixel, AWS Kinesis Firehose, pixel to AWS Kinesis Firehose, event tracking, free, open-source, Buz]
---

# Send pixel data to AWS Kinesis Firehose for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to AWS Kinesis Firehose using your **own infrastructure**.
