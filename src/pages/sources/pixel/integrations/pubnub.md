---
title: Send pixel data to Pubnub
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Pubnub.
keywords: [pixel, Pubnub, pixel to Pubnub, event tracking, free, open-source, Buz]
---

# Send pixel data to Pubnub for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Pubnub using your **own infrastructure**.
