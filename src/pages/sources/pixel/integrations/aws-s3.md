---
title: Send pixel data to AWS S3
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to AWS S3.
keywords: [pixel, AWS S3, pixel to AWS S3, event tracking, free, open-source, Buz]
---

# Send pixel data to AWS S3 for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to AWS S3 using your **own infrastructure**.
