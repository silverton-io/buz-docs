---
title: Send pixel data to NATS
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to NATS.
keywords: [pixel, NATS, pixel to NATS, event tracking, free, open-source, Buz]
---

# Send pixel data to NATS for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to NATS using your **own infrastructure**.
