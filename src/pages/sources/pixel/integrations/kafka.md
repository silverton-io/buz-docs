---
title: Send pixel data to Kafka
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Kafka.
keywords: [pixel, Kafka, pixel to Kafka, event tracking, free, open-source, Buz]
---

# Send pixel data to Kafka for free with Buz.
