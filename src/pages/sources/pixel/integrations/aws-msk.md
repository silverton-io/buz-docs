---
title: Send pixel data to AWS MSK
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to AWS MSK.
keywords: [pixel, AWS MSK, pixel to AWS MSK, event tracking, free, open-source, Buz]
---

# Send pixel data to AWS MSK for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to AWS MSK using your **own infrastructure**.
