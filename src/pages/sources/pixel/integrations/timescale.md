---
title: Send pixel data to Timescale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Timescale.
keywords: [pixel, Timescale, pixel to Timescale, event tracking, free, open-source, Buz]
---

# Send pixel data to Timescale for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Timescale using your **own infrastructure**.
