---
title: Send pixel data to Mongodb
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Mongodb.
keywords: [pixel, Mongodb, pixel to Mongodb, event tracking, free, open-source, Buz]
---

# Send pixel data to Mongodb for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Mongodb using your **own infrastructure**.
