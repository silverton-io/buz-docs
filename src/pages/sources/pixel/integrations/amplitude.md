---
title: Send pixel data to Amplitude
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Amplitude.
keywords: [pixel, Amplitude, pixel to Amplitude, event tracking, free, open-source, Buz]
---

# Send pixel data to Amplitude for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Amplitude using your **own infrastructure**.
