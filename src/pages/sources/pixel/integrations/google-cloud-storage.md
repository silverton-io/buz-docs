---
title: Send pixel data to Google Cloud Storage
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Google Cloud Storage.
keywords: [pixel, Google Cloud Storage, pixel to Google Cloud Storage, event tracking, free, open-source, Buz]
---

# Send pixel data to Google Cloud Storage for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Google Cloud Storage using your **own infrastructure**.
