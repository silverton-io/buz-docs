---
title: Send pixel data to MySQL
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to MySQL.
keywords: [pixel, MySQL, pixel to MySQL, event tracking, free, open-source, Buz]
---

# Send pixel data to MySQL for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to MySQL using your **own infrastructure**.
