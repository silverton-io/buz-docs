---
title: Send pixel data to Redpanda
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Redpanda.
keywords: [pixel, Redpanda, pixel to Redpanda, event tracking, free, open-source, Buz]
---

# Send pixel data to Redpanda for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect pixel data and send it to Redpanda using your **own infrastructure**.
