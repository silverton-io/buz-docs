---
title: Send pixel data to Google Pub/Sub
description: Buz is a free and open-source project that makes it easy to collect, validate, and load pixel data to Google Pub/Sub.
...
## Buz makes it easy to collect pixel data and send it to Google Pub/Sub using your **own infrastructure**.
