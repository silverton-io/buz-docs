---
title: Send Cloudevents data to Amplitude
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Cloudevents data to Amplitude.
keywords: [Cloudevents, Amplitude, Cloudevents to Amplitude, event tracking, free, open-source, Buz]
---

# Send Cloudevents data to Amplitude for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Cloudevents data and send it to Amplitude using your **own infrastructure**.
