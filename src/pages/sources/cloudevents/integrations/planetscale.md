---
title: Send Cloudevents data to Planetscale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Cloudevents data to Planetscale.
keywords: [Cloudevents, Planetscale, Cloudevents to Planetscale, event tracking, free, open-source, Buz]
---

# Send Cloudevents data to Planetscale for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Cloudevents data and send it to Planetscale using your **own infrastructure**.
