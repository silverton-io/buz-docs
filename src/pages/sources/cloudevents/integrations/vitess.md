---
title: Send Cloudevents data to Vitess
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Cloudevents data to Vitess.
keywords: [Cloudevents, Vitess, Cloudevents to Vitess, event tracking, free, open-source, Buz]
---

# Send Cloudevents data to Vitess for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Cloudevents data and send it to Vitess using your **own infrastructure**.
