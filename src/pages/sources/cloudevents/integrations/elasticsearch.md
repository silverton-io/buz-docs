---
title: Send Cloudevents data to Elasticsearch
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Cloudevents data to Elasticsearch.
keywords: [Cloudevents, Elasticsearch, Cloudevents to Elasticsearch, event tracking, free, open-source, Buz]
---

# Send Cloudevents data to Elasticsearch for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Cloudevents data and send it to Elasticsearch using your **own infrastructure**.
