---
title: Send Cloudevents data to Materialize
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Cloudevents data to Materialize.
keywords: [Cloudevents, Materialize, Cloudevents to Materialize, event tracking, free, open-source, Buz]
---

# Send Cloudevents data to Materialize for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Cloudevents data and send it to Materialize using your **own infrastructure**.
