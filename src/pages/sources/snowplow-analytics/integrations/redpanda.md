---
title: Send Snowplow Analytics data to Redpanda
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Redpanda.
keywords: [Snowplow Analytics, Redpanda, Snowplow Analytics to Redpanda, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to Redpanda for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to Redpanda using your **own infrastructure**.
