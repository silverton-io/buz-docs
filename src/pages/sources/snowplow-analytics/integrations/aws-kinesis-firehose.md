---
title: Send Snowplow Analytics data to AWS Kinesis Firehose
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to AWS Kinesis Firehose.
keywords: [Snowplow Analytics, AWS Kinesis Firehose, Snowplow Analytics to AWS Kinesis Firehose, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to AWS Kinesis Firehose for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to AWS Kinesis Firehose using your **own infrastructure**.
