---
title: Send Snowplow Analytics data to AWS Kinesis
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to AWS Kinesis.
keywords: [Snowplow Analytics, AWS Kinesis, Snowplow Analytics to AWS Kinesis, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to AWS Kinesis for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to AWS Kinesis using your **own infrastructure**.
