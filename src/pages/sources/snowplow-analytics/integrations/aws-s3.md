---
title: Send Snowplow Analytics data to AWS S3
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to AWS S3.
keywords: [Snowplow Analytics, AWS S3, Snowplow Analytics to AWS S3, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to AWS S3 for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to AWS S3 using your **own infrastructure**.
