---
title: Send Snowplow Analytics data to Planetscale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Planetscale.
...
## Buz makes it easy to collect Snowplow Analytics data and send it to Planetscale using your **own infrastructure**.
