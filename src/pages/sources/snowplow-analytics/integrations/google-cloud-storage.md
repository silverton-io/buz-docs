---
title: Send Snowplow Analytics data to Google Cloud Storage
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Google Cloud Storage.
keywords: [Snowplow Analytics, Google Cloud Storage, Snowplow Analytics to Google Cloud Storage, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to Google Cloud Storage for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to Google Cloud Storage using your **own infrastructure**.
