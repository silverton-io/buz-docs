---
title: Send Snowplow Analytics data to Pubnub
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Pubnub.
keywords: [Snowplow Analytics, Pubnub, Snowplow Analytics to Pubnub, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to Pubnub for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to Pubnub using your **own infrastructure**.
