---
title: Send Snowplow Analytics data to NATS
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to NATS.
keywords: [Snowplow Analytics, NATS, Snowplow Analytics to NATS, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to NATS for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to NATS using your **own infrastructure**.
