---
title: Send Snowplow Analytics data to Timescale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Timescale.
keywords: [Snowplow Analytics, Timescale, Snowplow Analytics to Timescale, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to Timescale for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to Timescale using your **own infrastructure**.
