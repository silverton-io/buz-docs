---
title: Send Snowplow Analytics data to Amplitude
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Amplitude.
keywords: [Snowplow Analytics, Amplitude, Snowplow Analytics to Amplitude, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to Amplitude for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to Amplitude using your **own infrastructure**.
