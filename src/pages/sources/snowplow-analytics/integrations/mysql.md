---
title: Send Snowplow Analytics data to MySQL
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to MySQL.
keywords: [Snowplow Analytics, MySQL, Snowplow Analytics to MySQL, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to MySQL for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to MySQL using your **own infrastructure**.
