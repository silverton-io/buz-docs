---
title: Send Snowplow Analytics data to Postgres
description: Buz is a free and open-source project that makes it easy to collect, validate, and load Snowplow Analytics data to Postgres.
keywords: [Snowplow Analytics, Postgres, Snowplow Analytics to Postgres, event tracking, free, open-source, Buz]
---

# Send Snowplow Analytics data to Postgres for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect Snowplow Analytics data and send it to Postgres using your **own infrastructure**.
