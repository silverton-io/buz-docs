---
title: Send self describing JSON data to Google Pub/Sub
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Google Pub/Sub.
keywords: [self describing JSON, Google Pub/Sub, self describing JSON to Google Pub/Sub, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Google Pub/Sub for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Google Pub/Sub using your **own infrastructure**.
