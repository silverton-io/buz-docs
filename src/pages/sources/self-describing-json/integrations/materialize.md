---
title: Send self describing JSON data to Materialize
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Materialize.
keywords: [self describing JSON, Materialize, self describing JSON to Materialize, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Materialize for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Materialize using your **own infrastructure**.
