---
title: Send self describing JSON data to Minio
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Minio.
keywords: [self describing JSON, Minio, self describing JSON to Minio, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Minio for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Minio using your **own infrastructure**.
