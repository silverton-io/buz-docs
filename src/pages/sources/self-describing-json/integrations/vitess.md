---
title: Send self describing JSON data to Vitess
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Vitess.
keywords: [self describing JSON, Vitess, self describing JSON to Vitess, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Vitess for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Vitess using your **own infrastructure**.
