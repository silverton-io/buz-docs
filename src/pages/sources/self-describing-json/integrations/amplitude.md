---
title: Send self describing JSON data to Amplitude
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Amplitude.
keywords: [self describing JSON, Amplitude, self describing JSON to Amplitude, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Amplitude for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Amplitude using your **own infrastructure**.
