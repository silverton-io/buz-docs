---
title: Send self describing JSON data to Planetscale
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Planetscale.
keywords: [self describing JSON, Planetscale, self describing JSON to Planetscale, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Planetscale for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Planetscale using your **own infrastructure**.
