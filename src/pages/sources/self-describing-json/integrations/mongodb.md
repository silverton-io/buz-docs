---
title: Send self describing JSON data to Mongodb
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Mongodb.
...
## Buz makes it easy to collect self describing JSON data and send it to Mongodb using your **own infrastructure**.
