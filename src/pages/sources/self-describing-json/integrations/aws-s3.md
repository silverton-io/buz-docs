---
title: Send self describing JSON data to AWS S3
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to AWS S3.
keywords: [self describing JSON, AWS S3, self describing JSON to AWS S3, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to AWS S3 for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to AWS S3 using your **own infrastructure**.
