---
title: Send self describing JSON data to AWS Kinesis Firehose
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to AWS Kinesis Firehose.
...
## Buz makes it easy to collect self describing JSON data and send it to AWS Kinesis Firehose using your **own infrastructure**.
