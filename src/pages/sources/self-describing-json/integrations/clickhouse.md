---
title: Send self describing JSON data to Clickhouse
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Clickhouse.
keywords: [self describing JSON, Clickhouse, self describing JSON to Clickhouse, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Clickhouse for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Clickhouse using your **own infrastructure**.
