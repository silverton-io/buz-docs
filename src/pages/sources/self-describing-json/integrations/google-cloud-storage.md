---
title: Send self describing JSON data to Google Cloud Storage
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Google Cloud Storage.
keywords: [self describing JSON, Google Cloud Storage, self describing JSON to Google Cloud Storage, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Google Cloud Storage for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Google Cloud Storage using your **own infrastructure**.
