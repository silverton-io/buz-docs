---
title: Send self describing JSON data to MySQL
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to MySQL.
keywords: [self describing JSON, MySQL, self describing JSON to MySQL, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to MySQL for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to MySQL using your **own infrastructure**.
