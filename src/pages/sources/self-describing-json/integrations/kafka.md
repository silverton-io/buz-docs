---
title: Send self describing JSON data to Kafka
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Kafka.
keywords: [self describing JSON, Kafka, self describing JSON to Kafka, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Kafka for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Kafka using your **own infrastructure**.
