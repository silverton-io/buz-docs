---
title: Send self describing JSON data to Postgres
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Postgres.
keywords: [self describing JSON, Postgres, self describing JSON to Postgres, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Postgres for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Postgres using your **own infrastructure**.
