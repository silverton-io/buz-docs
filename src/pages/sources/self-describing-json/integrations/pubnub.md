---
title: Send self describing JSON data to Pubnub
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Pubnub.
keywords: [self describing JSON, Pubnub, self describing JSON to Pubnub, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Pubnub for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Pubnub using your **own infrastructure**.
