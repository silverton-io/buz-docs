---
title: Send self describing JSON data to Redpanda
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to Redpanda.
keywords: [self describing JSON, Redpanda, self describing JSON to Redpanda, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to Redpanda for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to Redpanda using your **own infrastructure**.
