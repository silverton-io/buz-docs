---
title: Send self describing JSON data to AWS MSK
description: Buz is a free and open-source project that makes it easy to collect, validate, and load self describing JSON data to AWS MSK.
keywords: [self describing JSON, AWS MSK, self describing JSON to AWS MSK, event tracking, free, open-source, Buz]
---

# Send self describing JSON data to AWS MSK for free with Buz.

![buzflow](../../../../../static/img/buzflow.png)


## Buz makes it easy to collect self describing JSON data and send it to AWS MSK using your **own infrastructure**.
