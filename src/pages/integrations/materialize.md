---
description: Buz is an open-source project that makes it easy to send data to Materialize
...
Buz sends data to Materialize from a number of different sources including:
