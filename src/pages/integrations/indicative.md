---
description: Buz is an open-source project that makes it easy to send data to Indicative
...
Buz sends data to Indicative from a number of different sources including:
