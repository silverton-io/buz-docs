---
description: Buz is an open-source project that makes it easy to send data to Mongodb
...
Buz sends data to Mongodb from a number of different sources including:
