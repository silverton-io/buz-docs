---
description: Buz is an open-source project that makes it easy to send data to Google Cloud Storage
keywords: [Google Cloud Storage, event tracking, free, open-source, Buz]
---

# Send data to Google Cloud Storage for free with Buz.
...
Buz sends data to Google Cloud Storage from a number of different sources including:
