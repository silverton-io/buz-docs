---
description: Buz is an open-source project that makes it easy to send data to AWS S3
keywords: [AWS S3, event tracking, free, open-source, Buz]
---

# Send data to AWS S3 for free with Buz.
...
Buz sends data to AWS S3 from a number of different sources including:
