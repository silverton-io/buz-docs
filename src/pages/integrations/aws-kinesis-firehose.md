---
description: Buz is an open-source project that makes it easy to send data to AWS Kinesis Firehose
keywords: [AWS Kinesis Firehose, event tracking, free, open-source, Buz]
---

# Send data to AWS Kinesis Firehose for free with Buz.
...
Buz sends data to AWS Kinesis Firehose from a number of different sources including:
