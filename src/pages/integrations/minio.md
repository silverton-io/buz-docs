---
description: Buz is an open-source project that makes it easy to send data to Minio
keywords: [Minio, event tracking, free, open-source, Buz]
---

# Send data to Minio for free with Buz.
...
Buz sends data to Minio from a number of different sources including:
