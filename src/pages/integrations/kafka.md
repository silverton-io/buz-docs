---
description: Buz is an open-source project that makes it easy to send data to Kafka
keywords: [Kafka, event tracking, free, open-source, Buz]
---

# Send data to Kafka for free with Buz.
...
Buz sends data to Kafka from a number of different sources including:
