---
description: Buz is an open-source project that makes it easy to send data to Timescale
...
Buz sends data to Timescale from a number of different sources including:
