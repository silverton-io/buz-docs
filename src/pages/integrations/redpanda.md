---
description: Buz is an open-source project that makes it easy to send data to Redpanda
...
Buz sends data to Redpanda from a number of different sources including:
