---
description: Buz is an open-source project that makes it easy to send data to MySQL
...
Buz sends data to MySQL from a number of different sources including:
