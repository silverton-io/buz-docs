---
description: Buz is an open-source project that makes it easy to send data to AWS MSK
keywords: [AWS MSK, event tracking, free, open-source, Buz]
---

# Send data to AWS MSK for free with Buz.
...
Buz sends data to AWS MSK from a number of different sources including:
