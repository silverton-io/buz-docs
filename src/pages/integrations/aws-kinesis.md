---
description: Buz is an open-source project that makes it easy to send data to AWS Kinesis
keywords: [AWS Kinesis, event tracking, free, open-source, Buz]
---

# Send data to AWS Kinesis for free with Buz.
...
Buz sends data to AWS Kinesis from a number of different sources including:
