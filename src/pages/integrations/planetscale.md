---
description: Buz is an open-source project that makes it easy to send data to Planetscale
keywords: [Planetscale, event tracking, free, open-source, Buz]
---

# Send data to Planetscale for free with Buz.
...
Buz sends data to Planetscale from a number of different sources including:
