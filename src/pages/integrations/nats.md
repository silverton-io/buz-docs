---
description: Buz is an open-source project that makes it easy to send data to NATS
keywords: [NATS, event tracking, free, open-source, Buz]
---

# Send data to NATS for free with Buz.
...
Buz sends data to NATS from a number of different sources including:
